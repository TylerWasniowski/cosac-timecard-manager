...
async function createSlotBlocker(sessionId, staffId, startDateTimeObj, endDateTimeObj, description) {
    var sessionId = await getSession();
    var response = await rp({
        ...
        body: {
            ...
            EndTimeLong: endDateTimeObj.utc().unix() * 1000,
            From_date: endDateTimeObj.format(config.setmoreCreateAppointmentToAndFromDateFormat),
            StartTimeLong: startDateTimeObj.utc().unix() * 1000,
            ...
            endTime: endDateTimeObj.hours() * 60,
            eventId: null,
            eventSummary: null,
            frequency: '',
            ...
            stDate_label: endDateTimeObj.format(config.setmoreCreateAppointmentStartAndEndDateFormat),
            startDate: endDateTimeObj.format(config.setmoreCreateAppointmentStartAndEndDateFormat),
            startTime: 600,
            isPaid: 0,
            isRefund: 0,
            ...
            AptStartDate: startDateTimeObj.format(config.setmoreCreateAppointmentAptStartAndDateFormat),
            AptEndDate: endDateTimeObj.format(config.setmoreCreateAppointmentAptStartAndDateFormat),
            bookingId: '',
